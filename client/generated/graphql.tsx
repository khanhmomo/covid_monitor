...
export type CreatePostInput = {
  death: Scalars['Float'];
  healed: Scalars['Float'];
  infected: Scalars['Float'];
...
export type Mutation = {
  ...
  updateData: PostMutationResponse;
};
...
export type UpdateDataMutation = { __typename?: 'Mutation', updateData: { __typename?: 'PostMutationResponse', code: number, success: boolean, message?: string | null | undefined, post?: { __typename?: 'Data', id: string, title: string, infected: string, healed: string, death: string, updatedAt: any } | null | undefined } };

export type DatasQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type DatasQueryQuery = { __typename?: 'Query', datas?: Array<{ __typename?: 'Data', id: string, title: string, infected: string, healed: string, death: string, updatedAt: any }> | null | undefined };
...
export const UpdateDataDocument = gql`
    mutation UpdateData($updateDataInput: UpdateDataInput!) {
  updateData(updateDataInput: $updateDataInput) {
    code
    success
    message
    post {
 ...
 *   variables: {
 *      updateDataInput: // value for 'updateDataInput'
 *   },
 * });
 */
...
export const DatasQueryDocument = gql`
    query DatasQuery {
  datas {
    id
    title
...
/**
 * __useDatasQueryQuery__
 *
 * To run a query within a React component, call `useDatasQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `useDatasQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useDatasQueryQuery({
 *   variables: {
 *   },
 * });
 */
export function useDatasQueryQuery(baseOptions?: Apollo.QueryHookOptions<DatasQueryQuery, DatasQueryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<DatasQueryQuery, DatasQueryQueryVariables>(DatasQueryDocument, options);
      }
export function useDatasQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<DatasQueryQuery, DatasQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<DatasQueryQuery, DatasQueryQueryVariables>(DatasQueryDocument, options);
        }
export type DatasQueryQueryHookResult = ReturnType<typeof useDatasQueryQuery>;
export type DatasQueryLazyQueryHookResult = ReturnType<typeof useDatasQueryLazyQuery>;
export type DatasQueryQueryResult = Apollo.QueryResult<DatasQueryQuery, DatasQueryQueryVariables>;
